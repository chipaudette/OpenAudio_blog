...
const uint32_t step_time_ms = 2000;
...
void setConfiguration(int config) { 
  switch (config) {
    ...
    case config_mic_jack:
      ...
      //Set mixer gain (right channel only; left is already sent to SD)
      mixerIn.gain(0,0.0); mixerIn.gain(1,1.0);  
    ...
    case config_line_in:
      ...
      //Set mixer gain to use R-L as differential input; Normalize by reducing each channel to 50%
