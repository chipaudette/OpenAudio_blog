...
//define some variables for loop() to control time-keeping and gain-updating
...
void loop() {
  ...
  asm(" WFI"); //put processor to sleep until an interrupt is fired (such as by the Audio Library every 128 samples)
